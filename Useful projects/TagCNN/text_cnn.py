    ...
    def __init__(
       ...
       embedding_size, filter_sizes, num_filters, l2_reg_lambda):
        ...
        with tf.name_scope("embedding"):
            ...
            self.embedded_chars = data_helper._embedding_lookup_with_zero_padding(self.W, self.input_x)
        ...
        with tf.name_scope("loss"):
            cross_entropy = -tf.reduce_sum((self.input_y*tf.log(self.predictions+ 1e-9))+(1-self.input_y)* tf.log(1 - self.predictions + 1e-9),name="xentropy")
